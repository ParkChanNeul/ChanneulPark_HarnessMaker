...
REQUIRED_FILES = [
    ...
    '_workspace/03_language_map_audit.md',
    ...
    'domain/02_language_map/README.md', 'domain/02_language_map/language_target.schema.json',
    'domain/02_language_map/registry_manifest.json', 'domain/02_language_map/source_catalog.json',
    'domain/02_language_map/legacy_aliases.json', 'domain/02_language_map/legacy_migrations.json',
    'domain/02_language_map/language_varieties.json', 'domain/02_language_map/coverage_summary.json',
    'domain/02_language_map/grammar_constructions.json', 'domain/02_language_map/particle_functions.json',
    'domain/02_language_map/register_features.json', 'domain/02_language_map/discourse_patterns.json',
    'domain/02_language_map/interactional_functions.json', 'domain/02_language_map/core_interaction_chunks.json',
    'domain/02_language_map/phonology_features.json', 'domain/02_language_map/orthography_features.json',
    'domain/03_situations/situation_pack.schema.json',
    'domain/03_situations/situation_pack_manifest.json',
    'domain/03_situations/active_packs.json', 'domain/03_situations/reserved_packs.json',
    'domain/04_profiles/profile.schema.json', 'domain/04_profiles/profile_manifest.json',
    'domain/04_profiles/general_adult_conversation.json',
    'domain/04_profiles/overlays/korea_resident_worker.json',
    'domain/04_profiles/overlays/heritage_oral.json',
    'domain/04_profiles/overlays/heritage_reconnection.json',
    'domain/04_profiles/overlays/topik_exam.reserved.json',
    ...
    'scripts/build_language_map_seed.py', 'scripts/validate_language_map.py',
    'scripts/render_language_map_coverage.py',
    'tests/test_conversational_guards.py', 'tests/test_golden_run.py',
    'tests/test_language_map.py',
    '_workspace/02_semantic_validation_audit.md',
]

REQUIRED_DIRS = [
    '.codex/agents', '.agents/skills', 'contracts', 'contracts/conversation',
    'domain/02_language_map', 'domain/03_situations', 'domain/04_profiles',
    'domain/04_profiles/overlays',
    'tests/fixtures', 'tests/fixtures/conversation', 'tests/fixtures/golden/conversational_cafe',
    'tests/fixtures/language_map/valid', 'tests/fixtures/language_map/invalid',
